strings = Create Strings as file list: "fileList", "/Users/leonardoferraz/Documents/Coisas/Jobs/NayraPaiva/dados/contexto9"
fileCounter = Get number of strings

writeFileLine: "dados9.csv", "arquivo,", "sentenca,", "durSentenca,", "palavra,", "silaba,", "durSilaba,", "durPausaI,", "durPausaII,", "durPausaInesperada"
...
for i to fileCounter
	...
	label$ = Get label of interval: 2, j
		...
		sentenca$ = "A menina muito nova namorava"
...
appendFileLine: "dados9.csv", filename$, ",", sentenca$, ",", durSentenca, ",", palavraI$, ",", silabaI$, ",", durSilabaI, ",", durPausaI, ",", durPausaII, ",", durPausaIII
appendFileLine: "dados9.csv", filename$, ",", sentenca$, ",", durSentenca, ",", palavraII$, ",", silabaII$, ",", durSilabaII, ",", durPausaI, ",", durPausaII, ",", durPausaIII
