strings = Create Strings as file list: "fileList", "/Users/leonardoferraz/Documents/Coisas/Jobs/NayraPaiva/dados/contexto14"
fileCounter = Get number of strings

writeFileLine: "dados14.csv", "arquivo,", "sentenca,", "durSentenca,", "palavra,", "silaba,", "durSilaba,", "durPausaI,", "durPausaII,", "durPausaInesperada"
...
for i to fileCounter
	...
	label$ = Get label of interval: 2, j
		...
		sentenca$ = "A bela Lia mentirosa namorava"
...
appendFileLine: "dados14.csv", filename$, ",", sentenca$, ",", durSentenca, ",", palavraI$, ",", silabaI$, ",", durSilabaI, ",", durPausaI, ",", durPausaII, ",", durPausaIII
appendFileLine: "dados14.csv", filename$, ",", sentenca$, ",", durSentenca, ",", palavraII$, ",", silabaII$, ",", durSilabaII, ",", durPausaI, ",", durPausaII, ",", durPausaIII
